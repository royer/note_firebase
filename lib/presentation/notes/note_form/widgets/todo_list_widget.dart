...
import 'package:note_firebase/presentation/notes/note_form/misc/build_context_x.dart';
...
class TodoList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocListener<NoteFormBloc, NoteFormState>(
      listenWhen: (p, c) => p.note.todos.isFull != p.note.todos.isFull,
      listener: (context, state) {
        // show snapbar two ask buy preminu
      },
      child: Consumer<FormTodos>(
        builder: (context, formTodos, child) {
          return ImplicitlyAnimatedReorderableList<TodoItemPrimitive>(
            //TODO what is for? because parent use SingleChildScrollView?
            shrinkWrap: true,
...
class TodoTile extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final textEditingControl = useTextEditingController(text: todo.name);
    return Slidable(
      endActionPane: ActionPane(
        ...
        children: [
          SlidableAction(
            onPressed: (context) {
              //context.formTodos = context.formTodos.drop(index);
